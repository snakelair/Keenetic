...
## [1.0.156] - 2026-09-20 - Оптимизация проекта для ИИ и минимизация расхода токенов
- **Единый источник правды версий (Single Source of Truth)**:
  ...
  - Устранена необходимость редактирования 7 файлов при каждом инкременте версии.
- **Архивация истории релизов (Changelog Archiving)**:
  ...
  - Снижен объем передаваемого контекста и размер встроенного бандла.
- **Очистка репозитория и правила игнорирования для ИИ**:
  - Удален устаревший файл-дубликат `smart_route_user_guide.md`.
  - Созданы `.aiignore` и `.cursorignore` для исключения служебных файлов, бинарников и медиа из контекста ИИ-индексаторов.
...
- **Оптимизация системных правил (`AGENTS.md`)**:
  - Актуализирован регламент версионирования для резкого снижения расхода токенов в последующих сессиях.
